...
<%@ include file="../include/header.jsp"%>
	...
	<div class="mui-content">
		<form class="mui-input-group" action="<c:url value="/blog/doUpdate"/>" enctype="multipart/form-data" method="post">
			
			<input type="hidden" name="id" value="${data.id}" />
			<input type="hidden" name="image" value="${data.image}" />
			<div class="mui-input-row">
				<label>标题</label>
				<input type="text" name="title" class="mui-input-clear mui-input" value="${data.title}">
			</div>
			<div class="mui-input-row">
				<label>原图</label>
				<img style="height:100%" class="mui-media-object" src="<c:url value="/${data.image}"/>" />
			</div>
			<div class="mui-input-row">
				<label>图片</label>
			...
			<div class="mui-input-row">
				<label>正文</label>
				<textarea rows="" cols="" name="body">${data.body}</textarea>
			</div>
